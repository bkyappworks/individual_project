...
def saveDB(data):
    ...
    with connection:
        ...
        back = cursor.executemany("INSERT INTO job_raw (job_id,position,company,location,hiringstatus,posttime,savetime,url,description) VALUES(%s,%s,%s,%s,%s,%s,%s,%s,%s)", data) 
